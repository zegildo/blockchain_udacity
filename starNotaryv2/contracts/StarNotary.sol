...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        address address_1 = ownerOf(_tokenId1);
        address address_2 = ownerOf(_tokenId2);
        _transfer(address_1, address_2, _tokenId1);
        _transfer(address_2, address_1, _tokenId2); 
    }

    // Implement Task 1 Transfer Stars
    function transferStar(address _to1, uint256 _tokenId) public {
        require(ownerOf(_tokenId) == msg.sender, "You can't tranfer the Star you don't owned");
