...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Verify the result set:
        assert.equal(bufferOne[0], sku, 'Error: Invalid itemSKU');
        assert.equal(bufferOne[1], upc, 'Error: Invalid itemUPC');
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Verify the result set:
        assert.equal(bufferTwo[0], sku, 'Error: Invalid itemSKU');
        assert.equal(bufferTwo[1], upc, 'Error: Invalid itemUPC');
        assert.equal(bufferTwo[2], productID, 'Error: Invalid productID');
        assert.equal(bufferTwo[3], productNotes, 'Error: Invalid productNotes');
        assert.equal(bufferTwo[4], productPrice, 'Error: Invalid productPrice');
        assert.equal(bufferTwo[5], itemState, 'Error: Invalid itemState');
