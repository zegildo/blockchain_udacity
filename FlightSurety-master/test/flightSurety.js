...
contract('Flight Surety Tests', async (accounts) => {
  ...
  it("register 4 airlines directly", async() => {
    const owner = accounts[0];
    //first airline is already register
    ...
    await instanceApp.registerAirline(airline_2, "Azul Airlines", {from:owner});
    await instanceApp.registerAirline(airline_3, "American Airlines", {from:owner});
    let numAirlines = await instanceApp.getNumAirlinesRegistred.call();
    ...
    numAirlines = await instanceApp.getNumAirlinesRegistred.call();
